...
const double accErrpv[41]=
	      ...
	      ,0.0020292}; // WARNING: the last value is just replicated before-last until a better value is available!
const double  accErrmv[41]=
	      ...
	      ,0.0018471}; // WARNING! the last value is just replicated before-last until a better value is available!
